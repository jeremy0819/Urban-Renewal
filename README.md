...
| [🎮 simulator.html](simulator.html) | **都市更新整合策略沙盤 v4**（暖白×翡翠綠品牌）：24 戶＝有**人格／情緒／家族**的真人；難度由**情境×戶數×建商信用**決定（可手動調戶數）；**財務面板（總銷/成本/ROI 示意）＋競爭建商進度＋多結局**；策略卡對人格反應不同、tag 對應實際審議；盤面可排序、概念解鎖、總結報告 |
